...
(ADD-TO-LM '(GEORGE) '(HUMAN F-NAME (GEORGE) GENDER (MALE)) '((D1 A1) (D2 A21 A22)))
(print *lm)
(ADD-TO-LM '(HIGH SCHOOL) '(INSTITUTION TYPE (HIGHSCHOOL)) nil)

(print *lm)
(ADD-TO-LM '(HIGH SCHOOL) '(INSTITUTION TYPE (HIGHSCHOOL) NAME (RIDGEMONT)) '((D1 A2)))
